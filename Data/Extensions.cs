...
public static class Extensions
{
    public static void AddDatabaseToServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddDbContext<ElectronyatShopDbContext>(options =>
        {
            options.UseMySql(connectionString, new MySqlServerVersion(new Version(8, 0, 36))); // Match your MySQL version
