...
public class OrderController(ElectronyatShopDbContext context, UserManager<ApplicationUser> userManager) : Controller
{
	...
	[HttpGet]
	public async Task<IActionResult> Create([FromQuery] int cartId)
	{
		...
		return RedirectToAction("Success", new { cartId = cartId });
	}
	...
	[HttpGet]
	public IActionResult Success([FromQuery] int cartId)
	{
